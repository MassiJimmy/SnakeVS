...
def game():
    ...
    if scorej1>=10:
        if scorej1 == scorej2:
            ...
            if cx==dx and cy==dy:
                ...
                can.create_text(250,200,text="Le joueur 1 a gagné.",fill="green",font=("Arial",20))
    ...
    if scorej2>=10:
        if scorej2 == scorej1:
            ...
            if cx==dx and cy==dy:
                can.create_rectangle(0,0,500,400,fill="black")
                can.create_text(250,200,text="Le joueur 2 a gagné.",fill="blue",font=("Arial",20))
    ...
    def clavier(evt):
        global xv,yv,cx,cy,dx,dy,serpent,serpent2
